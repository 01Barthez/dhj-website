      ...
      <section className="w-full bgImage-contact py-20 md:py-36 lg:py-40  relative">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-heading font-bold mb-6">{t('contact.title', 'Contact Us')}</h1>
              <p className="text-xl">
                {t('contact.subtitle', 'We are here to answer all your questions')}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className=" shadow-sm p-6 rounded overflow-hidden shadow-german-gold">
        <Card className="overflow-hidden border-none shadow-xl">
          <CardContent className="p-0">
            <Map location={contactInfo.location} mapUrl={contactInfo.mapUrl} />
          </CardContent>
        </Card>
      </section>
    </div>
